...
/*
Interface (encapsulation_day_2.Car1) → Abstraction: Defines what a car can do, hides how it works.

Class (encapsulation_day_2.RealCar) → encapsulation_day_2.Encapsulation: Protects data (speed, gear, isRunning) using private + getters/setters.

Polymorphism → Used interface reference:
encapsulation_day_2.Car1 car = new encapsulation_day_2.RealCar(); → future-proof, flexible.
